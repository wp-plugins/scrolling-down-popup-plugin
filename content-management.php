  ...
  <div class="tool-box">
    ...
    <form name="sdp_display" method="post">
      <table width="100%" class="widefat" id="straymanage">
        <thead>
          <tr>
		  	<th width="15px" align="left" scope="col">Id</th>
            <th width="150px" align="left" scope="col">Short Code</th>
        ...
        ?>
          <tr class="<?php if ($i&1) { echo'alternate'; } else { echo ''; }?>">
		  	<td align="left" valign="middle"><?php echo(stripslashes($data->sdp_id)); ?></td>
            <td align="left" valign="middle">[scroll-down-popup id="<?php echo(stripslashes($data->sdp_id)); ?>"]</td>

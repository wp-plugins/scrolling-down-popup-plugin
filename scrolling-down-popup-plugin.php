...
function Scrolling_Down_Popup_filter($content)
{
	return 	preg_replace_callback('/\[SCROLL-DOWN-POPUP:(.*?)\]/sim','Scrolling_Down_Popup_filter_Callback',$content);
}

function Scrolling_Down_Popup_filter_Callback($matches) 
{
	global $wpdb;
...
add_filter('the_content', 'Scrolling_Down_Popup_filter');

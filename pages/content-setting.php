<div class="wrap">
  <div class="form-wrap">
	...
	<form name="sdp_form" method="post" action="">
		...
		<h3>Popup window display setting</h3>
		
		<label for="tag-image">Display on home page</label>
		...
		<label for="tag-image">Display on posts</label>
		...
		<label for="tag-image">Display on pages</label>
		...
		<label for="tag-image">Display on archives pages</label>
		...
		<label for="tag-image">Display on search pages</label>
		...
		<input name="sdp_submit" id="sdp_submit" class="button add-new-h2" value="Submit" type="submit" />
